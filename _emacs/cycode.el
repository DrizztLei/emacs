...
;(add-to-list 'load-path "/usr/share/emacs/24.5/lisp/cedet/ede")
;(add-to-list 'load-path "/usr/share/emacs/24.5/lisp/emacs-lisp")
;(add-to-list 'load-path "/usr/share/emacs/24.5/lisp/cedet/semantic")
;(load-file "/usr/share/emacs/24.5/lisp/cedet/cedet.el")
;(require 'cedet)
